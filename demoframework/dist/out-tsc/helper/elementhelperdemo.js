...
class ElementHelper {
    ...
    clickElement(locator, locatorType) {
        if (locatorType == 'css') {
            ...
            protractor_1.element(protractor_1.by.model(locator)).click();
        }
        else if (locatorType == 'xpath') {
            protractor_1.element(protractor_1.by.xpath(locator)).click();
        }
        else if (locatorType == 'btntext') {
            protractor_1.element(protractor_1.by.buttonText(locator)).click();
        }
        //log4jsConfig.log().debug('clicked on element', locator);
    }
    inputData(locator, text, locatorType) {
    ...
    getElement(locator, locatorType) {
        if (locatorType == 'css') {
            ...
            protractor_1.browser.wait(protractor_1.ExpectedConditions.visibilityOf(protractor_1.element(protractor_1.by.model(locator)))).then();
            return protractor_1.element(protractor_1.by.model(locator));
        }
        else if (locatorType == 'xpath') {
